            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="product__details__text">
                        ...
                        <a href="#" class="primary-btn" id="book_id" onclick="test()" type="submit" name="book_id">LOAN</a>
                        ...
                        <ul>
                           ...
                           echo "<li><b>Author</b> <span>" . $row["bookAuthor"]."</span></li>";
                           echo "<li><b>Publisher</b><span>".$row["book_publisher"]."</span></li>";
                           echo "<li><b>Publication Year</b> <span>".$row["book_date"]."</span></li>";
                        }
                    }else{
                    echo "테이블에 데이터가 없습니다.";
                    }
