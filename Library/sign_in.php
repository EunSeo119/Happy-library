                ...
                <div class="col-lg-9">
                    ...
                    <div class="container"> 
                        ...
                        <form action="login.php" method="post" class="form form-login" id="login">
                            <div class="input-form col-md-12 mx-auto" style="margin:auto; width:100%;"> 
                                <form class="validation-form" novalidate> 
                                    <div class="row">
                                        <div class="col" >
                                            <div class="col-md-9 mb-3"> 
                                                <label for="id">ID</label> 
                                                <input type="text" class="form-control" name = "user_ID" id="id" placeholder="" value="" required> 
                                                <div class="invalid-feedback"> 별명을 입력해주세요. </div> 
                                            </div>
                                            <div class="col-md-9 mb-3"> 
                                                <label for="pwd">비밀번호</label> 
                                                <input type="text" class="form-control" name="password" id="pwd" placeholder="" value="" required> 
                                                <div class="invalid-feedback"> 별명을 입력해주세요. </div> 
                                            </div>
                                        </div>   
                                        <div class="mb-4"></div>
